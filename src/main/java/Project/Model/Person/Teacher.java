...
public class Teacher extends Person {
    ...
    public Teacher(Role role, int id, String image, String token, String tel, String user, String firstName, String surName, String faceBookId, ArrayList<String> address) {
